...
class TaxonomyController
{
    ...
    public function destroy(Taxonomy $taxonomy, TaxonomyDeleteAction $action): JsonResponse
    {
        ...
        $menus = MenuItem::where('type', MenuItem::TYPE_CATEGORY_POST)->where('item_id', $taxonomy->rootTaxon->id ?? 0)->get();
    ...
    public function bulkDelete(AdminBulkDeleteRequest $request): JsonResponse
    {
        ...
        foreach ($request->input('id') as $id) {
            ...
            $menus = MenuItem::where('type', MenuItem::TYPE_CATEGORY_POST)->where('item_id', $taxon->id ?? 0)->get();
