...
@section('page-content')
    @include('admin.packages._form', [
        ...
        'package' => new \App\Domain\Package\Models\Package,
    ])
@stop
@push('css')
...
@push('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\PackageStoreRequest', '#package-form'); !!}
@endpush
